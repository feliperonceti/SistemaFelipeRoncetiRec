...
public class JDlgVendedorNovo extends javax.swing.JDialog {
    ...
    public JDlgVendedorNovo(java.awt.Frame parent, boolean modal) {
        ...
        jTablel1.setModel(vendedorControlle);
    }
    ...
    private void jBtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterarActionPerformed
      // TODO add your handling code here:
        ...
        VendedorFgv vendedorFgv =  vendedorControlle.getBean(rowSel);
        jDlgVendedorNovoIA.beanView(vendedorFgv);
    ...
    private void jBtnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluirActionPerformed
        ...
        if (Util.perguntar("Deseja execluir o registro") == true ) {
            ...
            vendedorFgv = vendedorControlle.getBean(sel);
            vendedor_DAO.delete(vendedorFgv);
